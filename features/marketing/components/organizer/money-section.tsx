  ...
  return (
    <section className="mx-auto max-w-6xl px-6 py-20 md:px-10 md:py-28">
      <div className="max-w-2xl">
        ...
        <h2 className="mt-4 text-[clamp(1.875rem,4vw,3rem)] font-bold leading-[1.1] tracking-[-0.025em]">
      ...
      <p className="mt-14 max-w-2xl text-sm text-foreground/45">
        Worked example: a {formatMoney(ticketMinor)} ticket → your buyer
        pays {formatMoney(totalMinor)} ({formatMoney(feeMinor)}{" "}
        service fee). You receive the full {formatMoney(ticketMinor)}.
      </p>
    </section>
  );
}
